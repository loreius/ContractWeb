 ...
 * This file demonstrates how to integrate Contractweb with a web frontend
 */

// For React/Vue/Angular applications
export class ContractwebClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ContractwebClient(provider, contractAddress);
