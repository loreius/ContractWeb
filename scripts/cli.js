...
const contractABI = require("../artifacts/contracts/Contractweb.sol/Contractweb.json").abi;

program
    .name("contractweb-cli")
    .description("CLI tool for Contractweb smart contract")
    .version("1.0.0");
